...
exports.getAnalysisQueue = void 0;
var request = require("request");
var getAnalysisQueue = function (field, queue, subqueue) {
    try {
        var options = {
        ...
        request.get(options, function (err, response, body) { return __awaiter(void 0, void 0, void 0, function () {
            var parsedBody, queues;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        queues = [];
                        return [4 /*yield*/, parsedBody.map(function (item) {
                                var queue = {
